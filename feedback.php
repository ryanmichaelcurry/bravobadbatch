...
$info = $apollo->select("cadet", ["id"=>$_GET["id"]])[0];
if(empty($info))
  ...
  <section id="feedback">
    <div class="container">
      <div class="row justify-content-center">
        <div class="col-lg-8 col-md-8 col-sm-10 col-xs-12 mb-3 mt-5">
        <form method="POST" action="/dofeedback.php">
          <input type="hidden" name="cadet" id="cadet" value="<?php echo $info["id"]; ?>">
          <textarea name="text" class="form-control" id="text" rows="4"></textarea>
          <input type="submit" href="feedback/3" class="btn btn-primary btn-lg mt-3" value="Give feedback">
        </form>
        </div>
      </div>
    </div>
